...
lazy val http4sDeps = Seq(deps.http4sServer, deps.http4sDsl, deps.http4sCirce, deps.http4sOtel4sMiddleware)
...
lazy val deps = new {
  ...
  val http4sOtel4sMiddleware = "org.http4s" %% "http4s-otel4s-middleware" % "0.3.0"
